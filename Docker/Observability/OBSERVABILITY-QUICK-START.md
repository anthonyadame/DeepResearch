...
```powershell
# From Docker/Observability directory
...
**Location**: `Docker/Observability/`  
**Need help?** See [OBSERVABILITY.md](./OBSERVABILITY.md) or [README.md](./README.md) for full documentation
